<template>
  <NuxtLayout name="default">
    <div id="datenschutz" class="container pt-5">
      <h4>Datenschutzerklärung</h4>

      <p>Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders hohen
        Stellenwert
        für die Geschäftsleitung der NetteSoftware. Eine Nutzung der Internetseiten der NetteSoftware ist grundsätzlich
      ...
      <p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift, E-Mail-Adresse oder
        ...
        Übereinstimmung mit den für die NetteSoftware geltenden landesspezifischen Datenschutzbestimmungen. Mittels
        dieser
        Datenschutzerklärung möchte unser Unternehmen die Öffentlichkeit über Art, Umfang und Zweck der von uns
        erhobenen,
        genutzten und verarbeiteten personenbezogenen Daten informieren. Ferner werden betroffene Personen mittels
        dieser
        Datenschutzerklärung über die ihnen zustehenden Rechte aufgeklärt.</p>

      <p>Die NetteSoftware hat als für die Verarbeitung Verantwortlicher zahlreiche technische und organisatorische
      ...
      <p>Die Datenschutzerklärung der NetteSoftware beruht auf den Begrifflichkeiten, die durch den Europäischen
      ...
      <p>NetteSoftware</p>
      <p>Ingenhovenweg 17</p>
      <p>41334 Nettetal</p>
      <p>Deutschland</p>
      <p>Tel.: 1212</p>
      <p>E-Mail: hallo@nette-software.de</p>
      <p>Website: https://nette-software.de</p>

      <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
      <p>Die Internetseite der NetteSoftware erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person
        oder
      ...
      <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die NetteSoftware keine Rückschlüsse auf die
        ...
        NetteSoftware daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die
      ...
      <p>Die Internetseite der NetteSoftware enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine schnelle
      ...
      <p>Die im Blog der NetteSoftware abgegebenen Kommentare können grundsätzlich von Dritten abonniert werden.
        Insbesondere besteht die Möglichkeit, dass ein Kommentator die seinem Kommentar nachfolgenden Kommentare zu
        einem
        bestimmten Blog-Beitrag abonniert.</p>

      <p>Sofern sich eine betroffene Person für die Option entscheidet, Kommentare zu abonnieren, versendet der für die
        ...
        Abonnement von Kommentaren kann jederzeit beendet werden.</p>
      ...
      <ul style="list-style: none;">
        <li>
          ...
          <p>Jede betroffene Person hat das vom Europäischen Richtlinien- und Verordnungsgeber eingeräumte Recht, von
            ...
            Anspruch
            nehmen, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
            wenden.
          </p>
        </li>
        <li>
          ...
          <ul style="list-style: none;">
            ...
            <li>das Bestehen einer automatisierten Entscheidungsfindung einschließlich Profiling gemäß Artikel 22 Abs.1
        ...
        <li>
          ...
          <p>Möchte eine betroffene Person dieses Berichtigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit
            an
            einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden.</p>
        </li>
        <li>
          ...
          <ul style="list-style: none;">
            ...
            <li>Die betroffene Person legt gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein, und es
          ...
          <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
            personenbezogenen
            Daten, die bei der NetteSoftware gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an
            einen
            Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der NetteSoftware wird
            veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.</p>

          <p>Wurden die personenbezogenen Daten von der NetteSoftware öffentlich gemacht und ist unser Unternehmen als
            Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so
            trifft
            die NetteSoftware unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten
            ...
            soweit
            die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der NetteSoftware wird im Einzelfall das Notwendige
            veranlassen.</p>
        </li>
        <li>
          ...
          <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
            ...
            wenn eine der folgenden Voraussetzungen gegeben ist:</p>
          ...
          <ul style="list-style: none;">
            ...
            <li>Die Verarbeitung ist unrechtmäßig, die betroffene Person lehnt die Löschung der personenbezogenen Daten
              ab
              und verlangt stattdessen die Einschränkung der Nutzung der personenbezogenen Daten.</li>
            ...
            <li>Die betroffene Person hat Widerspruch gegen die Verarbeitung gem. Art. 21 Abs. 1 DS-GVO eingelegt und es
          ...
          <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die Einschränkung von
            personenbezogenen Daten, die bei der NetteSoftware gespeichert sind, verlangen möchte, kann sie sich hierzu
            jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
            NetteSoftware wird die Einschränkung der Verarbeitung veranlassen.</p>
        </li>
        <li>
          ...
          <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
            ...
            DS-GVO
            oder auf einem Vertrag gemäß Art. 6 Abs. 1 Buchstabe b DS-GVO beruht und die Verarbeitung mithilfe
          ...
          <p>Ferner hat die betroffene Person bei der Ausübung ihres Rechts auf Datenübertragbarkeit gemäß Art. 20 Abs.
            1
          ...
          <p>Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person jederzeit an einen
            Mitarbeiter der NetteSoftware wenden.</p>
        ...
        <li>
          ...
          <p>Jede von der Verarbeitung personenbezogener Daten betroffene Person hat das vom Europäischen Richtlinien-
            ...
            f
            DS-GVO erfolgt, Widerspruch einzulegen. Dies gilt auch für ein auf diese Bestimmungen gestütztes Profiling.
          </p>

          <p>Die NetteSoftware verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei
            denn,
          ...
          <p>Verarbeitet die NetteSoftware personenbezogene Daten, um Direktwerbung zu betreiben, so hat die betroffene
            ...
            Verbindung steht. Widerspricht die betroffene Person gegenüber der NetteSoftware der Verarbeitung für Zwecke
            der Direktwerbung, so wird die NetteSoftware die personenbezogenen Daten nicht mehr für diese Zwecke
            verarbeiten.</p>

          <p>Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation ergeben,
            gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der NetteSoftware zu
          ...
          <p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an jeden Mitarbeiter der
            NetteSoftware oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner frei, im
        ...
        <li>
          ...
          <p>Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen der betroffenen
            ...
            Person, trifft die NetteSoftware angemessene Maßnahmen, um die Rechte und Freiheiten sowie die berechtigten
      ...
      <h4>8. Datenschutzbestimmungen zu Einsatz und Verwendung von LinkedIn</h4>
      <p>Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite Komponenten der LinkedIn Corporation
        ...
        registrierte Personen nutzen LinkedIn in mehr als 200 Ländern. Damit ist LinkedIn derzeit die größte Plattform
        für
      ...
      <p>Betreibergesellschaft von LinkedIn ist die LinkedIn Corporation, 2029 Stierlin Court Mountain View, CA 94043,
        USA. Für Datenschutzangelegenheiten außerhalb der USA ist LinkedIn Ireland, Privacy Policy Issues, Wilton Plaza,
      ...
      <p>Bei jedem einzelnen Abruf unserer Internetseite, die mit einer LinkedIn-Komponente (LinkedIn-Plug-In)
        ...
        LinkedIn-Plug-Ins
        können unter https://developer.linkedin.com/plugins abgerufen werden. Im Rahmen dieses technischen Verfahrens
        erhält LinkedIn Kenntnis darüber, welche konkrete Unterseite unserer Internetseite durch die betroffene Person
        besucht wird.</p>
      ...
      <p>Sofern die betroffene Person gleichzeitig bei LinkedIn eingeloggt ist, erkennt LinkedIn mit jedem Aufruf
        ...
        Informationen
        werden durch die LinkedIn-Komponente gesammelt und durch LinkedIn dem jeweiligen LinkedIn-Account der
        betroffenen
        Person zugeordnet. Betätigt die betroffene Person einen auf unserer Internetseite integrierten LinkedIn-Button,
        ordnet LinkedIn diese Information dem persönlichen LinkedIn-Benutzerkonto der betroffenen Person zu und
        speichert
      ...
      <p>LinkedIn erhält über die LinkedIn-Komponente immer dann eine Information darüber, dass die betroffene Person
        ...
        LinkedIn-Komponente anklickt oder nicht. Ist eine derartige Übermittlung dieser Informationen an LinkedIn von
        der
      ...
      <p>Art. 6 I lit. a DS-GVO dient unserem Unternehmen als Rechtsgrundlage für Verarbeitungsvorgänge, bei denen wir
        ...
        einer
        sonstigen Leistung oder Gegenleistung notwendig sind, so beruht die Verarbeitung auf Art. 6 I lit. b DS-GVO.
        Gleiches gilt für solche Verarbeitungsvorgänge die zur Durchführung vorvertraglicher Maßnahmen erforderlich
        sind,
        etwa in Fällen von Anfragen zur unseren Produkten oder Leistungen. Unterliegt unser Unternehmen einer
        rechtlichen
        Verpflichtung durch welche eine Verarbeitung von personenbezogenen Daten erforderlich wird, wie beispielsweise
        zur
        Erfüllung steuerlicher Pflichten, so basiert die Verarbeitung auf Art. 6 I lit. c DS-GVO. In seltenen Fällen
        könnte die Verarbeitung von personenbezogenen Daten erforderlich werden, um lebenswichtige Interessen der
        betroffenen Person oder einer anderen natürlichen Person zu schützen. Dies wäre beispielsweise der Fall, wenn
        ein
        Besucher in unserem Betrieb verletzt werden würde und daraufhin sein Name, sein Alter, seine Krankenkassendaten
      ...
      <h4>10. Berechtigte Interessen an der Verarbeitung, die von dem Verantwortlichen oder einem Dritten verfolgt
        werden
      </h4>
      ...
      <h4>12. Gesetzliche oder vertragliche Vorschriften zur Bereitstellung der personenbezogenen Daten;
        Erforderlichkeit
      ...
      <p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für
        Datenschutz GmbH, die als <a
          ...
          Datenschutzbeauftragter München</a> tätig ist, in Kooperation mit dem <a
          href="https://www.wbs.legal/">Rechtsanwalt für Datenschutzrecht Christian Solmecke</a> erstellt.
      </p>
    </div>
  </NuxtLayout>
</template>
...
<script setup>
useSeoMeta({
  title: 'Datenschutzerklärung – NetteSoftware',
